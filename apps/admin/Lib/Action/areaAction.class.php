...
class areaAction extends backendAction {
	...
	public function setting(){
		...
		$this->redirect('admin/area/manage',array('ik'=>'city','id'=>$parentid));
	}
	...
	public function addcity($str){
		if(IS_POST){
			...
			$this->redirect('admin/area/manage',array('ik'=>'city','id'=>$id));
	...
	public function adddistricts($str){
		if(IS_POST){
			...
			$this->redirect('admin/area/manage',array('ik'=>'districts','id'=>$id));
