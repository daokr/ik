...
class tagAction extends backendAction {
	...
	public function manage(){
		...
		$menu = array(
				'tags' => array('text'=>'标签管理', 'url'=>U('admin/tag/manage',array('ik'=>'tags'))),
				'addtag' => array('text'=>'添加标签', 'url'=>U('admin/tag/manage',array('ik'=>'addtag'))),
		);
	...
	public function addtag(){
		if(IS_POST){
			...
			$this->success('添加成功',U('admin/tag/manage',array('ik'=>'tags')));
		}else{
			$this->title ( '标签管理' );
	...
	public function delete(){
		...
		if(!empty($id)){
			...
			$this->redirect('admin/tag/manage');
		}
	}	
	//ajax删除数据
