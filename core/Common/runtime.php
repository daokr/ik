...
//修改改人小麦 静态文件目录 css imgages js 
defined('APP_STATIC_PATH')   or define('APP_STATIC_PATH',     APP_PATH.'Static/');
defined('APP_INFO_PATH')   or define('APP_INFO_PATH',     APP_PATH.'Appinfo/'); //定义app信息
...
function build_app_dir() {
    ...
    if(is_writeable(APP_PATH)) {
        $dirs  = array(
            ...
            LIB_PATH.'Behavior/',
            LIB_PATH.'Widget/',
            APP_STATIC_PATH, //app 静态文件 修改人小麦
            APP_INFO_PATH, //app 说明文件 修改人小麦
            );
        foreach ($dirs as $dir){ 
