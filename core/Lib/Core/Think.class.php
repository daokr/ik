...
class Think {
    ...
    static private function buildApp() {
        ...
        //修改人小麦 加载核心扩展函数库 function
        if(is_file(IK_EXTEND_PATH.'function/common.php')) {
        	include IK_EXTEND_PATH.'function/common.php';
        	// 编译文件
    ...
    public static function autoload($class) {
        ...
        if(substr($class,-8)=='Behavior') { // 加载行为
            ...
            if(require_array(array(
            	...
            	IK_EXTEND_PATH.'model/'.$file),true)) {
                return ;
            }
            ...
            if(require_array(array(
            	...
            	IK_EXTEND_PATH.'action/'.$file),true)) {
                return ;
            }
