...
<div class="cright">
	...
	<p class="pl">本页永久链接: <a href="<?php echo U('group/index/show',array(id=>$strGroup[groupid]));?>">http://www.ikphp.com<?php echo U('group/index/show',array(id=>$strGroup[groupid]));?></a></p>
