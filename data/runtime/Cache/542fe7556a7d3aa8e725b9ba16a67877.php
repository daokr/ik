...
<td><a href="<?php echo U('admin/area/manage',array('ik'=>'city','id'=>$item[areaid]));?>">[查看二级区域]</a></td>
<td>
<a href="<?php echo U('admin/area/add',array('ik'=>'city','id'=>$item[areaid]));?>">[添加二级区域]</a> &nbsp;&nbsp;
<a href="<?php echo U('admin/area/edit',array('ik'=>'province','id'=>$item[areaid]));?>">[编辑]</a> &nbsp;&nbsp;
<a href="<?php echo U('admin/area/delete',array('ik'=>'province','id'=>$item[areaid]));?>">[删除]</a>
</td>
