...
<div class="midder">
  <div class="mc">
    <h1>发送短消息</h1>
    <form method="POST" action="<?php echo U('public/message/write',array('touserid'=>$strTouser[userid]));?>">
      <table class="table_1" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
            ...
            <input type="submit" value="好了，发送" class="submit" />&nbsp;&nbsp;<a href="<?php echo U('public/message/ikmail',array('d'=>'inbox'));?>">取消</a>
            </td>
        </tr>
      </table>
    </form>
