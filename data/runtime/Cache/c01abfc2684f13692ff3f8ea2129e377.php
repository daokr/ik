...
<link rel="stylesheet" type="text/css" href="__ROOT__/apps/<?php echo ($app_name); ?>/Static/css/main.css" />
<!--[if gte IE 7]><!-->
...
<div class="LeftMenu">
    <div class="menubox">
        <ul id="root_index" class="MenuList" data-uri="<?php echo U('admin/index/left');?>"></ul>
        <div class="cl"></div>
    </div>
