...
<a class="btn_a" href="javascript:;" data-url="<?php echo U('admin/user/ajax_isenable',array('ik'=>$ik,'isenable'=>1));?>" onclick="Audit(this)">
<span>禁用</span>
</a> 
<a class="btn_a" href="javascript:;" data-url="<?php echo U('admin/user/ajax_isenable',array('ik'=>$ik,'isenable'=>0));?>" onclick="Audit(this)">
<span>启用</span>
</a> 
...
<td>
<?php if($item[isenable] == 0): ?><a href="<?php echo U('admin/user/isenable',array('ik'=>'user','id'=>$item[userid],'isenable'=>'1'));?>">[禁用]</a> 
<?php else: ?>
<a href="<?php echo U('admin/user/isenable',array('ik'=>'user','id'=>$item[userid],'isenable'=>'0'));?>">[启用]</a><?php endif; ?>
</td>
