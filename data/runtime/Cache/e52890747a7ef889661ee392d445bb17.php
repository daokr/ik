...
<a class="btn_a" href="javascript:;" data-url="<?php echo U('admin/tag/ajax_delete');?>" onclick="Delete(this)">
<span>删除选中</span>
</a>


<a class="btn_a" href="javascript:;" data-url="<?php echo U('admin/tag/ajax_audit',array('isenable'=>0));?>" onclick="Audit(this)">
<span>启用</span>
</a>  

<a class="btn_a" href="javascript:;" data-url="<?php echo U('admin/tag/ajax_audit',array('isenable'=>1));?>" onclick="Audit(this)">
<span>停用</span>
</a>
...
<td>
<a href="<?php echo U('admin/tag/delete',array('id'=>$item[tagid]));?>">[删除]</a> &nbsp;&nbsp;
<?php if($item[isenable] == 0): ?><a href="<?php echo U('admin/tag/isaudit',array('id'=>$item[tagid],'isenable'=>1));?>">[停用]</a> 
<?php else: ?>
<a href="<?php echo U('admin/tag/isaudit',array('id'=>$item[tagid],'isenable'=>0));?>">[启用]</a><?php endif; ?>
</td>
