...
<div class="tabnav">
<ul>
    <li class="select"><a href="<?php echo U('admin/words/lists');?>">词语过滤</a></li>
    <li><a href="<?php echo U('admin/words/addwords');?>">批量添加</a></li>
</ul>
</div>
<form enctype="multipart/form-data" action="<?php echo U('admin/words/lists');?>" method="post">
